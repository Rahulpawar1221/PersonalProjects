...
public class MainController {
	...
	public String deleteCountry(@PathVariable int country_id) {
		String str = service.deleteCountry(country_id);
		return str;
	}
	//--------------------------------------------------------------------------------------------------------
	...
	@GetMapping("getcountrybyid/{country_id}")
	public Country getParticularCountryById(@PathVariable int country_id) {
		Country country=service.getParticularCountryById(country_id);
		return country;
	}
	//--------------------------------------------------------------------------------------------------------
